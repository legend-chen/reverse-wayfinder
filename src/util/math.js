import { lerp, damp, lerpArray,
  clamp, inverseLerp, degToRad, mapRange, clamp01,
  radToDeg, linspace, smoothstep, mod} from "canvas-sketch-util/math";
import * as THREE from "three";


export * from "canvas-sketch-util/math";

export {lerp, lerpArray, clamp, inverseLerp, degToRad, damp, clamp01, mapRange, radToDeg, linspace, smoothstep, mod};

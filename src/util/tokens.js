import * as tokens from "../assets/image/tokens/ico_*.png";
import * as invertedTokens from "../assets/image/tokens-inverted/ico_*.png";
import * as collectedTokens from "../assets/image/tokens-collected/*.png";

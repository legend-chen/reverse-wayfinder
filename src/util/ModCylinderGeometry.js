...
function CylinderBufferGeometry({
  ...
  if (openBottom === false && radiusBottom > 0) generateCap(false);
  ...
  this.setAttribute("capState", new Float32BufferAttribute(capState, 1));
  this.setAttribute("vertexAngle", new Float32BufferAttribute(angles, 1));
  ...
  function generateTorso() {
    ...
    for (let y = 0; y <= heightSegments; y++) {
      ...
      for (let x = 0; x <= radialSegments; x++) {
        ...
        angles.push((x / (radialSegments + 1)) * thetaLength + thetaStart);
